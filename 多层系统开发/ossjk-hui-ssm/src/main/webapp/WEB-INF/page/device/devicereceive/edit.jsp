			...
			<div class="panel-body">
				<form action="${pageContext.request.contextPath}${requestScope.record != null ?  '/device/devicereceive/update.do' :'/device/devicereceive/insert.do'}" method="post" class="form form-horizontal" id="form">
					...
					<div class="row clearfix">
						...
						<div class="formControls col-xs-8 col-sm-9">
						   <select class="input-text" id="recipients" name="recipients">
							   <option value="0">--请选择--</option>
					...
					<div class="row clearfix">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="<fmt:formatDate value="${requestScope.record.receivedate }" pattern="yyyy-MM-dd"/>" placeholder="" id="receivedate" name="receivedate">
						</div>
					</div>
					<div class="row clearfix">
						<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>领用备注：</label>
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="${requestScope.record.rcremarks }" placeholder="" id="rcremarks" name="rcremarks">
						</div>
					</div>
					<div class="row clearfix">
